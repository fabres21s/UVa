...
public class Main {
	...
	static int toDecimal(String caracter)
	{
		...
		for (int carac = 0; carac<longitud; carac++)
		{
			...
			case 'C':
			if ((carac < longitud - 1) && (caracter.charAt(carac+1) == 'M')) 
			resultado -= 100;
			else if ((carac < longitud - 1) && (caracter.charAt(carac+1) == 'D'))
			resultado -= 100; 
			else
			resultado += 100;
			...
			if ((carac < longitud - 1) && (caracter.charAt(carac+1) == 'C'))
			resultado -= 10;
			else if ((carac < longitud - 1) && (caracter.charAt(carac+1) == 'L'))
			resultado -= 10;
			else
			resultado += 10;
			...
			break;
			case 'I':
				if ((carac < longitud - 1) && (caracter.charAt(carac+1) == 'X'))
			resultado -= 1;
			else if ((carac < longitud - 1) && (caracter.charAt(carac+1) == 'V'))
			resultado -= 1;
			else
			resultado += 1;
