...
public class Main10929 {
	 ...
	 * - Proceso matem�tico
	 * 
	 * Determinar si un n�mero es multiplo de 11
	 * El proceso consiste en sumar todos los n�meros en las posiciones pares
	 * y en las posiciones impares, por separado, y si la resta entre ellos 
	 * es multiplo de 11, el n�mero original tambi�n lo es.
	 * Ej 142857
