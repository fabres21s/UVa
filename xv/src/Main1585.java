...
public class Main1585 {
	 ...
	 *	por la primera O se suma 1, por la segunda 2 y as�
	...
	public static void main(String [] args) {
		...
		//No entiendo por qu� el input.nextInt() e input.next() generaban RE - Toc� pasarlo a input.nextLine() - debe ser por el package
		char [] array;
		int sum, acum;
		while (test -- > 0){
