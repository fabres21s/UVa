...
public class Main 
{
	...
	private void print() 
	{
		...
		if (maxNapTime < 60) 
		{
			out.println(String.format(formatedString1, day, napStartTime, maxNapTime));
		}
		else
		{
			out.println(String.format(formatedString2, day, napStartTime, maxNapTime/60, maxNapTime%60));
		}
	}        
