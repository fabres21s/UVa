...
public class Main11364 {
	 ...
	 * - Simulaci�n
	 * 
	 * Dado un arreglo, ordenarlo, sacar el promedio y encontrar el n�mero que m�s se acerque a dicho promedio
	 * para posteriormente encontrar las diferencias absolutas con el primer y �ltimo elemento del arreglo
	 * y multiplicarlas por 2.
	 * 
	 * Los arreglos son distancias en un centro comercial, desde los parqueaderos, hac�a las tiendas,
