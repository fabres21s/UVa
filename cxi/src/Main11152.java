...
public class Main {
	 ...
	 * 
	 * Dadas las medidas de un triángulo, hallar el área del círculo externo, menos la del tríangulo,
	 * y hallar el área del círculo interno al triángulo, y cuánto le queda al triángulo
	 * @param args
	 */
