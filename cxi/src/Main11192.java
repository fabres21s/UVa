	...
	public static void main(String[] args) {
		...
		while (input.hasNext()){
			...
			if (group > 0){
				 ...
				 group = length /group;
				 while (size < length) {
					 aux = new StringBuffer(cadena.subSequence(size, size+group));
...
iScrnaoyguvimesemoceiritacilpntupselsaHereiemscydoWeroskifenuBWtWAyh
hesreveRpuorG29111SBaaBnmocenoediptt
eRpuorG29111ediptthesrevSBaaBnmoceno
eRpuorG29111ediptthesrevSBaaBnmoceno
uorG29111hesreveRpenoedipttSBaaBnmoc
G29111eRpuorhesrevedipttmocenoSBaaBn
9111orG2eRpusrevttheedipcenoBnmoSBaa
9111orG2eRpusrevttheedipcenoBnmoSBaa
111G29uoreRprevhespttedienomocaBnSBa
